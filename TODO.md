...
**Perhaps consider starting with Revert Changes**
    - It is more costly to pass large prompts to the model, so consider reverting any changes that significantly increase prompt size. a.k.a the idea of passing a small resume into the prompt may not be the best approach.
